	...
	<form>
		<div class="top-section"></div>
			<div class="form-container">
				...
				<div class="input_row">
					<input type="text" name="findname" class="input_style" placeholder="이름을 입력하세요."/>
				</div>
				<div class="input_row">
					<input type="text" name="findphone" class="input_style" placeholder="핸드폰 번호를 입력하세요."/>
				</div>
				
				<div class="input_row">
					<input type="submit" value="비밀번호 찾기" class="btn" onclick="alert('비밀번호 찾기 성공')"/> 
				</div>
