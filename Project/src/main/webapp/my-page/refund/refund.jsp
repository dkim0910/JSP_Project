...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/my-page/refund/refund.css">
</head>
...
<body style="cursor: default;">
    <div class="container">
        ...
        <section class="products-section" id="remove-style" style="min-height: 100vh; display: flex; flex-direction: column;">
            ...
            <!-- 환불할 제품이 있는 경우 -->
            <c:if test="${not empty getRefunds}">
                <h2>환불 제품 목록</h2>
                <ul class="product-list">
                    <c:forEach var="refund" items="${getRefunds}">
                        <li class="product-item" onclick="showRefundForm('${refund.product_name}', '${refund.order_num}')">
                            <img src="${refund.image_url}" alt="${refund.product_name}" class="product-image">
                            <span class="product-name">${refund.product_name}</span>
        ...
        <section class="refund-form-section" id="refund-form-section">
            ...
            <form id="refund-form">
                ...
                <a href="my-page/refund/finish-refund.jsp"><button type="button" class="submit-button" onclick="submitRefund()">환불 신청하기</button></a>
            </form>
        </section>
...
<script src="${pageContext.request.contextPath}/my-page/refund/refund.js"></script>
