...
public class MembeUpdateAction implements Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        member.setUser_name(request.getParameter("user_name")); // 수정된 이름
        member.setUser_pw(request.getParameter("user_pw")); // 수정된 비밀번호
        ...
        member.setUser_gender(request.getParameter("user_gender")); // 수정된 성별
